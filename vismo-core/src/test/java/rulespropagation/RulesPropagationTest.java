...
public class RulesPropagationTest {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final RulesPropagationManager rulesManager1 = new RulesPropagationManager(engine1, 9996);
        final RulesPropagationManager rulesManager2 = new RulesPropagationManager(engine2, 9997);
        final RulesPropagationManager rulesManager3 = new RulesPropagationManager(engine3, 9998);
        final RulesPropagationManager rulesManager4 = new RulesPropagationManager(engine4, 9999);
        final RulesPropagationManager rulesManager5 = new RulesPropagationManager(engine5, 10000);
        final RulesPropagationManager rulesManager6 = new RulesPropagationManager(engine6, 10001);
        final RulesPropagationManager rulesManager7 = new RulesPropagationManager(engine7, 10002);
        final RulesPropagationManager rulesManager8 = new RulesPropagationManager(engine8, 10003);
        final RulesPropagationManager rulesManager9 = new RulesPropagationManager(engine9, 10004);
        final RulesPropagationManager rulesManager10 = new RulesPropagationManager(engine10, 10005);
        final RulesPropagationManager rulesManager11 = new RulesPropagationManager(engine11, 10006);
        final RulesPropagationManager rulesManager12 = new RulesPropagationManager(engine12, 10007);
        final RulesPropagationManager rulesManager13 = new RulesPropagationManager(engine13, 10008);
        final RulesPropagationManager rulesManager14 = new RulesPropagationManager(engine14, 10009);
        final RulesPropagationManager rulesManager15 = new RulesPropagationManager(engine15, 10010);

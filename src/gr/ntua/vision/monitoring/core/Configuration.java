...
public class Configuration
{
	...
	/** the variable name suffix for attribute separator. */
	public static final String				ProbeAttributeListSeparator	= ".attr.sep";
	/** the variable name suffix for key-value separator. */
	public static final String				ProbeKeyValueSeparator		= ".kv.sep";
	...
	{
		LocalCatalog ctg = LocalCatalogFactory.localCatalogInstance();
		...
		for( String name : probeNames )
			try
			{
				if( !live.contains( name ) )
				{
					...
					Character attrSep = ctg.as( GlobalCfgKey, name + ProbeAttributeListSeparator, Character.class );
					if( attrSep == null ) throw new Exception( "attributes separator" );
					Character kvSep = ctg.as( GlobalCfgKey, name + ProbeKeyValueSeparator, Character.class );
					if( kvSep == null ) throw new Exception( "key-value separator" );

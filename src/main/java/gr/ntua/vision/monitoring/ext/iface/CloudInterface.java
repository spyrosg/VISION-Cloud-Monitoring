...
public class CloudInterface {
    ...
    private enum Variables {
        ...
        Alive(new Function<String, Void>() {
            ...
            public Void apply(final String arg0) {
                ...
                } else if( VismoCtxListener.instance().isAlive( CloudMonitoring.class ) )
        ...
        LocalCatalogs(new Function<String, Void>() {
            @Override
            public Void apply(final String arg0) {
                final String[] clusters = arg0.split( ";" );
    ...
    public String registerAggregationRule(@FormParam("rule") final String rule) throws JSONException {
        ...
        if( compiled != null ) //
            ...
            wr.key( "reason" ).value( failure_reason );
    ...
    @Produces("application/json")
    public String setCloudMonitoringParameter(@QueryParam("name") final String name, @QueryParam("value") final String value)
            throws JSONException {
